...
if text1 and text2:
    ...
    if insights1 and insights2:
        ...
        if insights1 != insights2:
            ...
            # You can implement your own comparison logic here based on your specific task
        
    else:
        print("Error: Unable to generate insights from one or both files.")
else:
    print("Error: Unable to read text from one or both files.")
